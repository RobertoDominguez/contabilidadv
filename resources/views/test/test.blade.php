...
<head>
    <base href="../../">
    <meta charset="utf-8" />
    <title>Metronic | Stats Widgets</title>
                                                ...
                                                <ul class="menu-subnav">
                                                        ...
                                                        <div
                                                            ...
                                                            <ul class="menu-subnav">
                                                                ...
                                                                <li class="menu-item " aria-haspopup="true"><a
                                                                        ...
                                                                        class="menu-link "><i
                                                                            class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                            class="menu-text">Line Tabs</span></a>
                                                                </li>
                                                                <li class="menu-item " aria-haspopup="true"><a
                                                        ...
                                                        <div
                                                            ...
                                                            <ul class="menu-subnav">
                                                                ...
                                                                <li class="menu-item " aria-haspopup="true"><a
                                                                        ...
                                                                        class="menu-link "><i
                                                                            class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                            class="menu-text">SVG Icons</span></a>
                                                                </li>
                                                                <li class="menu-item " aria-haspopup="true"><a
                                                        ...
                                                        <div class="menu-submenu menu-submenu-classic menu-submenu-right"
                                                            ...
                                                            <ul class="menu-subnav">
                                                                ...
                                                                <li class="menu-item " aria-haspopup="true"><a
                                                                        ...
                                                                        class="menu-link "><i
                                                                            class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                            class="menu-text">Block UI</span></a>
                                                                </li>
                                                                <li class="menu-item " aria-haspopup="true"><a
                                                                ...
                                                                <li class="menu-item " aria-haspopup="true"><a
                                                                        ...
                                                                        class="menu-link "><i
                                                                            class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                            class="menu-text">Tree View</span></a>
                                                                </li>
                                                                <li class="menu-item " aria-haspopup="true"><a
                                                    ...
                                                    <li class="menu-item " aria-haspopup="true"><a target="_blank"
                                                            ...
                                                            class="menu-link "><span class="svg-icon menu-icon">
                                                                ...
                                                                <!--end::Svg Icon-->
                                                            </span><span class="menu-text">Layout
                                                                Builder</span></a></li>
                                                </ul>
                                            </div>
                                        </li>
                                                    ...
                                                    <li class="menu-item  menu-item-submenu" data-menu-toggle="hover"
                                                        aria-haspopup="true"><a href="javascript:;"
                                                            class="menu-link menu-toggle"><span
                                                                ...
                                                                <!--end::Svg Icon-->
                                                            </span><span class="menu-text">Forms &
                                                                Controls</span><i class="menu-arrow"></i></a>
                                                        <div
                                                            class="menu-submenu menu-submenu-classic menu-submenu-right">
                                                            <ul class="menu-subnav">
                                                                <li class="menu-item  menu-item-submenu"
                                                        ...
                                                        <div
                                                            ...
                                                            <ul class="menu-subnav">
                                                                ...
                                                                <li class="menu-item " aria-haspopup="true"><a
                                                                        ...
                                                                        class="menu-link "><i
                                                                            class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                            class="menu-text">Profile 2</span></a>
                                                                </li>
                                                                <li class="menu-item " aria-haspopup="true"><a
                                                                        href="custom/apps/profile/profile-3.html"
                                                                        class="menu-link "><i
                                                                            class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                            class="menu-text">Profile 3</span></a>
                                                                </li>
                                                                <li class="menu-item " aria-haspopup="true"><a
                                                                        href="custom/apps/profile/profile-4.html"
                                                                        class="menu-link "><i
                                                                            class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                                            class="menu-text">Profile 4</span></a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </li>
                                                    ...
                                                    <li class="menu-item  menu-item-submenu" data-menu-toggle="hover"
                                                        aria-haspopup="true"><a href="javascript:;"
                                                            class="menu-link menu-toggle"><span
                                                                ...
                                                                <!--end::Svg Icon-->
                                                            </span><span class="menu-text">Support
                            ...
                            <div class="dropdown">
                                ...
                                <div
                                    ...
                                    <div class="d-flex align-items-center p-8 rounded-top">
                                        ...
                                        <span
                                            class="label label-light-success label-lg font-weight-bold label-inline">3
                                            messages</span>
                                        <!--end::Text-->
                                    </div>
                                    <div class="separator separator-solid"></div>
                                        ...
                                        <div class="card-body d-flex align-items-center py-0 mt-8">
                                            <div class="d-flex flex-column flex-grow-1 py-2 py-lg-5">
                                                <a href="#"
                                                    ...
                                                    Authors</a>
                                                <span class="font-weight-bold text-muted  font-size-lg">Most Awards
                                                    Earned</span>
                                            </div>
                                        ...
                                        <div class="card-body d-flex align-items-center py-0 mt-8">
                                            <div class="d-flex flex-column flex-grow-1 py-2 py-lg-5">
                                                <a href="#"
                                                    ...
                                                    Bestsellers</a>
                                                <span class="font-weight-bold text-muted  font-size-lg">Rising
                                                    Stars</span>
                                            </div>
                                        ...
                                        <div class="card-body d-flex align-items-center py-0 mt-8">
                                            <div class="d-flex flex-column flex-grow-1 py-2 py-lg-5">
                                                <a href="#"
                                                    ...
                                                    Experts</a>
                                                <span class="font-weight-bold text-muted  font-size-lg">Ask Everything
                                                    You Wish</span>
                                            </div>
                                ...
                                <div class="col-xl-4">
                                    ...
                                    <div class="card card-custom bg-light-warning card-stretch gutter-b">
                                        ...
                                        <div class="card-body my-4">
                                            ...
                                            <div class="font-weight-bold text-muted font-size-sm"><span
                                                    class="text-dark-75 font-weight-bolder font-size-h2 mr-2">87K%</span>23k
                                                to goal</div>

                                            <div class="progress progress-xs mt-7 bg-warning-o-60">
                                                <div class="progress-bar bg-warning" role="progressbar"
                                                    style="width: 87%;" aria-valuenow="50" aria-valuemin="0"
                                                    aria-valuemax="100"></div>
                                            </div>
                                        </div>
                                        <!--end::Body-->
                                ...
                                <div class="col-xl-4">
                                    ...
                                    <div class="card card-custom bg-light-info card-stretch gutter-b">
                                        ...
                                        <div class="card-body my-4">
                                            ...
                                            <div class="font-weight-bold text-muted font-size-sm"><span
                                                    class="text-dark-75 font-weight-bolder font-size-h2 mr-2">52,450</span>48k
                                                to goal</div>

                                            <div class="progress progress-xs mt-7 bg-info-o-60">
                                                <div class="progress-bar bg-info" role="progressbar"
                                                    style="width: 52%;" aria-valuenow="50" aria-valuemin="0"
                                                    aria-valuemax="100"></div>
                                            </div>
                                        </div>
                                        <!--end::Body-->
                                ...
                                <div class="col-xl-4">
                                    ...
                                    <div class="card card-custom bgi-no-repeat card-stretch gutter-b"
                                        ...
                                        <div class="card-body my-4">
                                            ...
                                            <div class="font-weight-bold text-muted font-size-sm"><span
                                                    class="text-dark-75 font-weight-bolder font-size-h2 mr-2">67%</span>Avarage
                                            </div>
                                ...
                                <div class="col-xl-4">
                                    ...
                                    <div class="card card-custom bg-info card-stretch gutter-b">
                                        ...
                                        <div class="card-body my-4">
                                            ...
                                            <div class="font-weight-bold text-white font-size-sm"><span
                                                    class="font-size-h2 mr-2">87K%</span>23k to goal</div>
                                ...
                                <div class="col-xl-4">
                                    ...
                                    <div class="card card-custom bg-dark card-stretch gutter-b">
                                        ...
                                        <div class="card-body my-4">
                                            ...
                                            <div class="font-weight-bold text-white font-size-sm"><span
                                                    class="font-size-h2 mr-2">52,450</span>48k to goal</div>
                                ...
                                <div class="col-xl-3">
                                    ...
                                    <div class="card card-custom bg-light-danger card-stretch gutter-b">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <span class="font-weight-bold text-muted font-size-sm">New
                                                Customers</span>
                                        </div>
                                        <!--end::Body-->
                                    </div>
                                ...
                                <div class="col-xl-3">
                                    ...
                                    <div class="card card-custom bg-info card-stretch gutter-b">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <span class="font-weight-bold text-white  font-size-sm">New
                                                Customers</span>
                                        </div>
                                        <!--end::Body-->
                                    </div>
                                ...
                                <div class="col-xl-3">
                                    ...
                                    <div class="card card-custom bg-danger card-stretch gutter-b">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <span class="font-weight-bold text-white  font-size-sm">Milestone
                                                Reached</span>
                                        </div>
                                        <!--end::Body-->
                                    </div>
                                ...
                                <div class="col-xl-3">
                                    ...
                                    <div class="card card-custom bg-dark card-stretch gutter-b">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <span class="font-weight-bold text-white  font-size-sm">Support
                                                Tickets</span>
                                        </div>
                                        <!--end::Body-->
                                    </div>
                    ...
                    <div class="navi navi-icon-circle navi-spacer-x-0">
                        ...
                        <a href="#" class="navi-item">
                            <div class="navi-link rounded">
                                <div class="symbol symbol-50 mr-3">
                                    <div class="symbol-label"><i
                                            class="flaticon-notepad text-primary icon-lg"></i></div>
                                </div>
                                <div class="navi-text">
                                    <div class="font-weight-bold  font-size-lg">
                        ...
                        <a href="#" class="navi-item">
                            <div class="navi-link rounded">
                                <div class="symbol symbol-50 mr-3">
                                    <div class="symbol-label"><i
                                            class="flaticon-users-1 text-warning icon-lg"></i></div>
                                </div>
                                <div class="navi-text">
                                    <div class="font-weight-bold  font-size-lg">
                        ...
                        <a href="#" class="navi-item">
                            <div class="navi-link rounded">
                                <div class="symbol symbol-50 mr-3">
                                    <div class="symbol-label"><i
                                            class="flaticon2-download text-success icon-lg"></i></div>
                                </div>
                                <div class="navi-text">
                                    <div class="font-weight-bold  font-size-lg">
    ...
    <ul class="sticky-toolbar nav flex-column pl-2 pr-2 pt-3 pb-3 mt-4">
        ...
        <li class="nav-item mb-2" data-toggle="tooltip" title="Layout Builder" data-placement="left">
            <a class="btn btn-sm btn-icon btn-bg-light btn-icon-primary btn-hover-primary"
                href="https://preview.keenthemes.com/metronic/preview/demo2/builder.html" target="_blank">
