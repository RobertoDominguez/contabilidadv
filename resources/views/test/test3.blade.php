                                                ...
                                                <ul class="menu-subnav">
                                                    <li class="menu-item  menu-item-active " aria-haspopup="true"><a
                                                            href="index.html" class="menu-link "><span
                                                                class="menu-text">Latest Updated</span><span
                                        ...
                                        <div class="col-xl-9">
                                            ...
                                            <div class="card card-custom gutter-b" style="height: 150px">
                                                ...
                                                <div
                                                    ...
                                                    <a href="#"
                                                        class="btn btn-primary font-weight-bold py-3 px-6">Start
                                                        Now</a>
                                                </div>
                                                <!--end::Body-->
                                            </div>
                                                ...
                                                <table class="table table-head-custom table-vertical-center"
                                                    ...
                                                    <thead>
                                                        <tr class="text-left">
                                                            ...
                                                            <th class="pr-0" style="width: 50px">authors
                                                            </th>
                                    ...
                                    <div class="card card-custom card-stretch gutter-b">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="d-flex align-items-center bg-light-info rounded p-5">
                                                ...
                                                <!--begin::Lable-->
                                                <span
                                                    class="font-weight-bolder text-info py-1 font-size-lg">+8%</span>
                                                <!--end::Lable-->
                                            </div>
                                            <!--end::Item-->
                                        </div>
