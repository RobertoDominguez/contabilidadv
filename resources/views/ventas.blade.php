    ...
    <div class="card card-custom gutter-b example example-compact">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control form-control-solid" value="{{ $total }}" />
            </div>
            <div class="form-group">
                <label class="font-weight-bold">Caja Roja (Bs.)</label>
                <input type="text" class="form-control form-control-solid" value="{{ $caja_roja }}" />
            </div>

            <div class="form-group">
                <label class="font-weight-bold">Caja Verde (Bs.)</label>
                <input type="text" class="form-control form-control-solid" value="{{ $caja_verde }}" />
            </div>

            <div class="form-group">
                <label class="font-weight-bold">F. Secos (Bs.)</label>
                <input type="text" class="form-control form-control-solid" value="{{ $f_secos }}" />
            </div>

            <div class="form-group">
                <label class="font-weight-bold">Wafles (Bs.)</label>
                <input type="text" class="form-control form-control-solid" value="{{ $wafles }}" />
            </div>
        </div>
    </div>
