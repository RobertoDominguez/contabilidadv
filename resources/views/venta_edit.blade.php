...
@section('content')
    ...
    <div class="card card-custom gutter-b example example-compact">
        ...
        <form action="{{ route('venta.update', $venta->id) }}" method="POST" class="form"
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="name" class="form-control form-control-solid" name="nombre"
                        placeholder="Introduce el nombre del cliente..." value="{{ $venta->nombre }}" required />
                </div>
                <div class="form-group">
                    <label>Observaciones</label>
                    <input type="name" class="form-control form-control-solid" name="observaciones"
                        placeholder="Introduce la observacion si existe..." value="{{ $venta->observaciones }}" />
                </div>
                                            ...
                                            <center>
                                                ...
                                                @foreach ($venta->detalles as $detalle)
                                                    @if ($detalle->id_producto == $producto->id)
                                                        <input class="form-control form-control-solid" name="values[]"
                ...
                <div class="form-group">
                    ...
                    <input type="number" step="0.01" min="0" max="999" class="form-control form-control-solid" name="total"
                        placeholder="Introduce el total de la venta" value="{{ $venta->total }}" required />
                </div>
            </div>
